...
<?php
	...
	$resultado=mysqli_query( $conectar, "SELECT * FROM turmas WHERE softDelete != 1 ORDER BY 'id'");
			...
			<?php 
				while($linhas = mysqli_fetch_array($resultado)){
					echo "<tr>";
						...
						<a href='processa/proc_apagar_turma.php?id=<?php echo $linhas['id']; ?>'><button type='button' class='btn btn-sm btn-danger'>Apagar</button></a>
