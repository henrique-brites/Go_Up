...
<?php
	...
	$resultado=mysqli_query($conectar, "SELECT * FROM categorias WHERE softDelete != 1 ORDER BY 'id'");
			...
			<?php 
				while($linhas = mysqli_fetch_array($resultado)){
					echo "<tr>";
						...
						<a href='processa/proc_apagar_cat_cont.php?id=<?php echo $linhas['id']; ?>'><button type='button' class='btn btn-sm btn-danger'>Apagar</button></a>
