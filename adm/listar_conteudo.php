<?php
	...
	$resultado=mysqli_query( $conectar, "SELECT * FROM conteudos WHERE softDelete != 1 ORDER BY 'id'");
			...
			<?php 
				while($linhas = mysqli_fetch_array($resultado)){
					echo "<tr>";
						...
						<a href='processa/proc_apagar_conteudo.php?id=<?php echo $linhas['id']; ?>'><button type='button' class='btn btn-sm btn-danger'>Apagar</button></a>
